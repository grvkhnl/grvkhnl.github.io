...
\begin{tikzpicture}[font=\small, scale=0.88]
  ...
  \begin{scope}[shift={(7.6,0)}]
    ...
    \draw[tanvec, softgreen!80!black]
      (pfth) -- ++(1.05, 0.50)
      node[right, font=\footnotesize] {$\partial_i p$};
    \draw[tanvec, softgreen!50!black]
      (pfth) -- ++(0.85,-0.58)
      node[right, font=\footnotesize] {$\partial_j p$};
 
    \node[softgreen!70!black, font=\footnotesize\bfseries]
      at (0.0,-1.55) {$g_p(\dot p,\dot q)=\int \dot p\dot q/p$};
  \end{scope}
  ...
  \draw[dfstyle]
    ...
    node[midway, below=3pt, font=\scriptsize, midblue]
      {$df_\theta\colon\partial_i\mapsto\partial_i p$};
