...
**Chentsov's Theorem [5] (informal).** The Fisher-Rao metric is the unique Riemannian metric on the statistical manifold, up to a positive scalar multiple, that is monotone/invariant under Markov morphisms, or equivalently under statistically sufficient transformations in the finite setting.
:::
