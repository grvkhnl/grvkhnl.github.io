...
![The pullback origin of the Fisher Information Matrix. The parameter manifold $\mathcal M$ maps into the space of distributions $\mathcal P$ through the model map $f$, tangent directions push forward to score functions, and the $L^2$ inner product on scores pulls back to the Fisher metric.](figures/fim-pullback-origin.svg){#fig-fim-pullback width="100%" fig-alt="Diagram showing parameter space mapping into distribution space, with tangent vectors pushed forward to score functions and the Fisher metric obtained as a pullback."}
