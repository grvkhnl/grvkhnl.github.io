...
Here $\mathbb V_\theta$ denotes variance under $p(\cdot\,;\theta)$.
...
where $\mathrm{Cov}_\theta$ denotes covariance under $p(\cdot\,;\theta)$, and $\succeq$ denotes the Loewner partial order on positive semidefinite matrices. No unbiased estimator can have covariance smaller than $F(\theta)^{-1}$.
